  ...
  return (
    <div className="mt-10 scale-[1.05]">
      <div className="fixed left-28 top-16 justify-start">
        <button
          onClick={handleBack}
          className="flex items-center bg-purple-50 text-purple-600 font-bold text-md border border-purple-200 pr-5 pl-4 py-2 rounded-full hover:bg-purple-200  disabled:opacity-30"
        >
